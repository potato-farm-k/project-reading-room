...
- 현재 파일이 있는 Guide는 `WEB-001`, `WEB-002`, `WEB-003`, `WEB-004`, `WEB-005`, `WEB-006`, `WEB-007`입니다.
- `WEB-008` 이후 문서는 해당 주제를 실제로 학습할 때 만듭니다.
...
[WEB-007. How HTTP Works](./WEB-007-How-HTTP-Works.md)에서 브라우저와 서버가 HTTP Request와 Response를 통해 통신하는 방식을 살펴봅니다.
